...
export default function PrototypeAnimation() {
  ...
  useEffect(() => {
    return takeInterval(() => setVisible(v => ++v), { ticks: 150, takes: 4 })
  }, [setVisible])
